...
| {% icon check %} | └➔&nbsp;`payeenInfo`         | `object`      | {% include fields/payeeinfo.md %}                                                                                                                                                                                                                                              |
...
| └➔&nbsp;`payeeInfo`      | `string`     | The URL to the  payeeinfo  resource where the information about the payee of the payment can be retrieved.                                                                                                                                                                                                                                                 |
