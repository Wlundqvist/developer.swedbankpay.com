...
| {% icon check %} | └➔&nbsp;`description`        | `string(40)`  | {% include fields/description.md documentation_section="trustly" %}                                                                                                                                                                                                                     |
| {% icon check %} | └➔&nbsp;`userAgent`          | `string`      | {% include fields/user-agent.md %}                                                                                                                                                                                                                              |
| {% icon check %} | └➔&nbsp;`language`           | `string`      | {% include fields/language.md api_resource="trustly" %}                                                                                                                                                                                                                                 |
...
|                  | └─➔&nbsp;`logoUrl`           | `string`      | {% include fields/logourl.md documentation_section="trustly" %}                                                                                                                                                                |
...
| {% icon check %} | └➔&nbsp;`payeeInfo`          | `object`      | {% include fields/payeeinfo.md documentation_section="trustly" %}                                                                                                                                                                                                                                              |
| {% icon check %} | └─➔&nbsp;`payeeId`           | `string`      | This is the unique id that identifies this payee (like merchant) set by Swedbank Pay.                                                                                                                                                                                                              |
| {% icon check %} | └─➔&nbsp;`payeeReference`    | `string(30*)` | {% include fields/payee-reference.md documentation_section="trustly" %}                                                                                                                                                                                                                 |
