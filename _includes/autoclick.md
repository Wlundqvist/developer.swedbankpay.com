...
| └➔&nbsp;`status`          | `string`     | {% include fields/status.md %} | {% else %}
...
| └➔&nbsp;`payer`         | `string`     | {% include fields/payer.md %}                                                                                                          |
...
| └➔&nbsp;`history`     | `string`     | {% include fields/history.md %}                                                                                                                            |
| └➔&nbsp;`failed`     | `string`     | {% include fields/failed.md %}                                                                                                                            |
| └➔&nbsp;`aborted`     | `string`     | {% include fields/aborted.md %}                                                                                                                            |
| └➔&nbsp;`paid`     | `string`     | {% include fields/paid.md %}                                                                                                                            |
| └➔&nbsp;`cancelled`     | `string`     | {% include fields/cancelled.md %}                                                                                                                            |
| └➔&nbsp;`financialTransactions`     | `string`     | {% include fields/financial-transactions.md %}                                                                                                                            |
| └➔&nbsp;`failedAttempts`     | `string`     | {% include fields/failed-attempts.md %}                                                                                                                            |
