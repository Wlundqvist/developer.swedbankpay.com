...

{
    "payment": {
        ...
        "description": "Test Purchase", {% if documentation_section == "payment-menu" or documentation_section contains "checkout" %}
...
| {% icon check %} | └➔&nbsp;`description`             | `string(40)`  | {% include fields/description.md %}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | {% if documentation_section == "payment-menu" or documentation_section contains "checkout" %}
|                  | └➔&nbsp;`generateUnscheduledToken`| `boolean`     | `true` or `false`. Set to `true` if you want to generate an `unscheduledToken` for future unscheduled purchases (Merchant Initiated Transactions).                                                                                                                                                                                                                                                                                                                                                                                                                                                 | {% else %}
|                  | └➔&nbsp;`generatePaymentToken`| `boolean`     | `true` or `false`. Set to `true` if you want to generate a `paymentToken` for future unscheduled purchases (Merchant Initiated Transactions).                                                                                                                                                                                                                                                                                                                                                                                                                                                 | {% endif %}
...
|                  | └─➔&nbsp;`termsOfServiceUrl`      | `string`      | {% include fields/terms-of-service-url.md %}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
|                  | └➔&nbsp;`metadata`                | `object`      | {% include fields/metadata.md documentation_section="card" %}                                                                                                                                                                                                                                                                                                                                                                                      |
...

{
    "payment": {
        ...
        "userAgent": "Mozilla/5.0...",
        "language": "sv-SE", {% if documentation_section == "payment-menu" or documentation_section contains "checkout" %}
...
| └➔&nbsp;`language`                | `string`     | {% include fields/language.md %}                                                                                                                                                                                                                                                                                      | {% if documentation_section == "payment-menu" or documentation_section contains "checkout" %}
| └➔&nbsp;`unscheduledToken`     | `string`     | The generated unscheduled token, if `operation: Verify`, `operation: UnscheduledPurchase` or `generateUnscheduledToken: true` was used.                                                                                                                                                                  | {% else %}
| └➔&nbsp;`paymentToken`     | `string`     | The generated payment token, if `operation: Verify`, `operation: UnscheduledPurchase` or `generatePaymentToken: true` was used.                                                                                                                                                                  | {% endif %}
...
| {% icon check %} | └➔&nbsp;`unscheduledToken`     | `string`     | The unscheduledToken generated in the initial purchase, if `operation: Verify` or `generateUnscheduledToken: true` was used.                                                                                                                                                                  |
| {% icon check %} | └➔&nbsp;`currency`                | `string`      | NOK, SEK, DKK, USD or EUR.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| {% icon check %} | └─➔&nbsp;`amount`                 | `integer`     | {% include fields/amount.md %}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| {% icon check %} | └─➔&nbsp;`vatAmount`              | `integer`     | {% include fields/vatamount.md %}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
