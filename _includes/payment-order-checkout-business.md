...
| {% icon check %} | └➔&nbsp;`implementation`           | `string`     | Indicates which implementation to use. Mandatory for Business implementation.                                                                                                                                                                                                                                                                        |
...
| {% icon check %} | └─➔&nbsp;`termsOfServiceUrl`       | `string`     | {% include fields/termsofserviceurl.md %}                                                                                                                                                                                                                                                     |{% if include.integration_mode=="redirect" %},
...
|                  | └─➔&nbsp;`subsite`                | `String(40)` | The subsite field can be used to perform split settlement on the payment. The subsites must be resolved with Swedbank Pay [reconciliation]({{ features_url }}/core/settlement-reconciliation) before being used. Must be in the format of `A-Za-z0-9`.                                                                                         |
...
| {% icon check %} | └➔&nbsp;`orderItems`               | `array`      | {% include fields/orderitems.md %}                                                                                                                                                                                                                                                            |
...

{
    "paymentorder": {
        ...
        "availableInstruments": [
          ...
          "CreditAccount",
          "Trustly" ],
        "implementation": "Business", {% if include.integration_mode=="seamless-view" %}
...
| └➔&nbsp;`guestMode`       | `bool`     | Set to `true` or `false`. Indicates if the payer chose to pay as a guest or not. When using the Business implementation,this is triggered if the payer chooses to proceed as a guest when given the option during checkin.                                                                                                                                                   |
